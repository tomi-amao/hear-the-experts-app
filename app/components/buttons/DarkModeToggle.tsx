  ...
  return (
    <Form method="post" action="/">
      <div className="flex flex-row-reverse">
        <Switch.Root
          className=" w-[42px] h-[25px] bg-bgprimary6 dark:bg-txtsecondary rounded-full relative shadow-[0_2px_10px] shadow-bgprimary4 focus:shadow-[0_0_0_2px] focus:shadow-black data-[state=checked]:bg-black outline-none cursor-default"
